...
namespace Log4Qt
{
    ...
    inline int LoggingEvent::line() const
    { return mLine; }

    inline QString LoggingEvent::file() const
    { return mFile; }

    inline QString LoggingEvent::function() const
    { return mFunction; }

    inline QString LoggingEvent::category() const
    { return mCategory; }
