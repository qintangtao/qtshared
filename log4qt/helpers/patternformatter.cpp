...
namespace Log4Qt
{
    ...
    */
	PatternFormatter::PatternFormatter(const QString &rPattern) :
        ...
        mIgnoreCharacters(QLatin1String("l")),
        //mConversionCharacters(QLatin1String("cdmprtxX")),
        mConversionCharacters(QLatin1String("cdmprtxXLFMC")),
	                                       ...
	                                       const QString &rOption)
	{
		...
		switch (rChar.toLatin1())
		{
            ...
            case 'M':
                mPatternConverters << new BasicPatternConverter(rFormattingInfo,
                                                                BasicPatternConverter::METHOD_CONVERTER);
                break;
            case 'L':
                mPatternConverters << new BasicPatternConverter(rFormattingInfo,
            ...
            case 'C':
                mPatternConverters << new BasicPatternConverter(rFormattingInfo,
                                                                BasicPatternConverter::CATEGORY_CONVERTER);
                break;
			default:
	...
	QString BasicPatternConverter::convert(const LoggingEvent &rLoggingEvent) const
	{
		switch (mType)
		{
	        ...
	        case THREAD_CONVERTER:
	        	...
	        	break;
            case FILE_CONVERTER:
                return rLoggingEvent.file();
                break;
            case METHOD_CONVERTER:
                return rLoggingEvent.function();
                break;
            case LINE_CONVERTER:
                return QString::number(rLoggingEvent.line());
                break;
            case CATEGORY_CONVERTER:
                return rLoggingEvent.category();
                break;
	        default:
	...
	QDebug BasicPatternConverter::debug(QDebug &rDebug) const
	{
		...
		switch (mType)
		{
	        ...
	        case THREAD_CONVERTER:
	        	...
	        	break;
            case FILE_CONVERTER:
                type = QLatin1String("FILE_CONVERTER");
                break;
            case METHOD_CONVERTER:
                type = QLatin1String("METHOD_CONVERTER");
                break;
            case LINE_CONVERTER:
                type = QLatin1String("LINE_CONVERTER");
                break;
            case CATEGORY_CONVERTER:
                type = QLatin1String("CATEGORY_CONVERTER");
                break;
	        default:
