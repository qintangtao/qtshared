...
namespace Log4Qt
{
	...
	class LevelRangeFilter : public Filter
	{
        ...
        Q_PROPERTY(QString levelMax WRITE setLevelMax)

        Q_PROPERTY(QString levelMin WRITE setLevelMin)
	...
	public:
        ...
        void setLevelMax(const QString &level);
        void setLevelMin(const QString &level);
    ...
    inline void LevelRangeFilter::setLevelMax(const QString &level)
    { mLevelMax = OptionConverter::toLevel(level, Level::OFF_INT); }

    inline void LevelRangeFilter::setLevelMin(const QString &level)
    { mLevelMin = OptionConverter::toLevel(level, Level::NULL_INT); }
