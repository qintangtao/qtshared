...
namespace Log4Qt
{
	...
	class LevelMatchFilter : public Filter
	{
        ...
        Q_PROPERTY(QString levelToMatch WRITE setLevelToMatch)
	...
	public:
        ...
        void setLevelToMatch(const QString &level);
    ...
    inline void LevelMatchFilter::setLevelToMatch(const QString &level)
    {  mLevelToMatch = OptionConverter::toLevel(level, Level::NULL_INT); }
