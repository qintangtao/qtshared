...
namespace Log4Qt
{
	...
	class AppenderSkeleton : public Appender
	{
        ...
        Q_PROPERTY(QString threshold WRITE setThreshold)
	...
	public:
        ...
        void setThreshold(const QString &level);
    ...
    inline void AppenderSkeleton::setThreshold(const QString &level)
    { mThreshold = OptionConverter::toLevel(level, Level::NULL_INT); }
